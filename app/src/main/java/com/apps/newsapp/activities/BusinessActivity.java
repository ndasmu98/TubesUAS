                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(BusinessActivity.this, "Gagal memuat data!", Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onError(ANError anError) {
                        progressDialog.dismiss();
                        Toast.makeText(BusinessActivity.this, "Tidak tersambung jaringan internet!", Toast.LENGTH_SHORT).show();
                    }
                });
    }
