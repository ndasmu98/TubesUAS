                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(TechnologyActivity.this, "Gagal memuat data!", Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onError(ANError anError) {
                        progressDialog.dismiss();
                        Toast.makeText(TechnologyActivity.this, "Tidak tersambung jaringan internet!", Toast.LENGTH_SHORT).show();
                    }
                });
    }
