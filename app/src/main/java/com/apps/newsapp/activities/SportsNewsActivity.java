                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(SportsNewsActivity.this, "Gagal memuat data data!", Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onError(ANError anError) {
                        progressDialog.dismiss();
                        Toast.makeText(SportsNewsActivity.this, "Tidak tersambung jaringan internet!", Toast.LENGTH_SHORT).show();
                    }
                });
    }
