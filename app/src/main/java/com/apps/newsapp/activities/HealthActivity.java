...
public class HealthActivity extends AppCompatActivity implements NewsAdapter.onSelectData{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.setTitle("Harap ditunggu");
        progressDialog.setCancelable(false);
        progressDialog.setMessage("Sedang mememuat data");
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(HealthActivity.this, "Gagal memuat data!", Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onError(ANError anError) {
                        progressDialog.dismiss();
                        Toast.makeText(HealthActivity.this, "Tidak tersambung jaringan internet!", Toast.LENGTH_SHORT).show();
                    }
                });
    }
